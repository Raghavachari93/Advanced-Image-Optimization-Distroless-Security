...
<head>
  <meta charset="UTF-8">
  <title>Go REST API with Distroless Docker Image</title>
</head>
<body>
  ...
  <pre><code>docker run -d -p 5002:5002 --name secure-go-api go-api-secure</code></pre>

  <p>The application will be available at:</p>
  <pre><code>http://localhost:5002</code></pre>

  <hr>

  <h2>Stop and Remove Container</h2>
  <pre><code>docker stop secure-go-api
docker rm secure-go-api</code></pre>

  <hr>

  <h2>Verify Running Container</h2>
  <pre><code>docker ps
docker logs secure-go-api</code></pre>
